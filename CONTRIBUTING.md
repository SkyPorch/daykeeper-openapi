...
requirements for retried mutations. Never expose private conversation-infrastructure
provider identifiers, routes, credentials, or response bodies. Public payment and
email-provider fields remain documented where they are part of the stable contract.
